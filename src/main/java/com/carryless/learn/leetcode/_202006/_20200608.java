...
public class _20200608 {
	 ...
	 * @param yNode
	 */
	public static void unitNode(int[] parent, int xNode, int yNode){
		int rootXNode = findRoot(parent, xNode);
		parent[rootXNode] = findRoot(parent, yNode);
	}
}
